...
<div class="container">
	...
	<span style="font-size:25px; color:blue"><center class="animate__animated animate__pulse animate__infinite infinite"><strong>Event-Driven Programming Progressive Web-Application</strong></center></span>	
		<span class="pull-left animate__animated animate__bounce"><a href="#addnew" data-toggle="modal" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add New</a></span>
			...
			<?php
				...
				while($row=mysqli_fetch_array($query)){
					...
					<tr>
						...
						<td>
							<a href="#show_info<?php echo $row['userid']; ?>" data-toggle="modal" class="btn btn-warning"><span class="glyphicon glyphicon-eye-open animate__animated animate__rubberBand animate__infinite infinite"></span> Show</a> || 
